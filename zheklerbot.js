...
app.get ('/twovtwoscores/:channel', async (request, response) => {
  try {
    ...
    console.log(`${res[0].hkills},${res[0].tkills},${res[0].o1kills},${res[0].o2kills},${res[0].tname},${res[0].o1name},${res[0].o2name},${userIds[res[0].userid] && userIds[res[0].userid]["two_v_two"]},${userIds[res[0].tname] && userIds[res[0].tname]["two_v_two"] && rows[1].perms && rows[1].perms.split(',').includes(res[0].tname.toLowerCase())},${userIds[res[0].o1name] && userIds[res[0].o1name]["two_v_two"] && rows[1].perms && rows[1].perms.split(',').includes(res[0].o1name.toLowerCase())},${userIds[res[0].o2name] && userIds[res[0].o2name]["two_v_two"] && rows[1].perms && rows[1].perms.split(',').includes(res[0].o2name.toLowerCase())},${res[0].mapreset}`.split(','));
